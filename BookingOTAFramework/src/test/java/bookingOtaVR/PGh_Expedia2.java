...

{
   ...
   public void TestData() throws Exception
   {
     ...
     System.setProperty("webdriver.chrome.driver","D:\\Drivers\\104\\chromedriver.exe");
	...
	Object[][] Bookingdata=FileFunctions.ReadExcelData("D:\\SelenenumTestData\\Subhash_automation_file\\MappingInputFile_Expedia.xlsx","List");  
	   for(int i=1;i<Bookingdata.length;i++)
	   {
		   ...
		   */
		   ...
		   try {
			   String currenturl=driver.findElement(By.cssSelector("head > base")).getAttribute("href");
			   BookingMap.put(ws_hotelid, currenturl);BookingMap.put(Starrating, currenturl);
			   } catch(Exception e) {}
		   ...
		   writeExcel("D:\\SelenenumTestData\\Subhash_automation_file\\MappingInputFile_Expedia.xlsx","List",i);
