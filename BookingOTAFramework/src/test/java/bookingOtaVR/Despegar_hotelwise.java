...
public class Despegar_hotelwise
   ...
   public void TestData() throws Exception
   {
	...
	Object[][] Bookingdata=FileFunctions.ReadExcelData("D:\\SelenenumTestData\\MappingInputFile.xlsx","List");  
	   for(int i=1;i<Bookingdata.length;i++)
	   {
		  ...
		  //String hotelfulldetails= driver.findElement(By.cssSelector("head > script:nth-child(27)")).getAttribute("innerHTML").toString();
          //System.out.println(".............."+hotelfulldetails);
	       String AgodaHotelname=driver.findElement(By.cssSelector("body > aloha-app-root > aloha-detail > div > div:nth-child(2) > div > div > div > aloha-accommodation-name > div > h1")).getText();
	       BookingMap.put(ws_hotelname, AgodaHotelname);
	       String AgodaHotelAddress=driver.findElement(By.cssSelector("#roompacks-container-wrapper > aloha-location-map-container > aloha-dummy-map-image > div > div > p.eva-3-body-1.-eva-3-tc-gray-2")).getText();
