   ...
   public void TestData() throws Exception
   {
     ...
     options.addArguments("--remote-allow-origins=*");
		...
		driver=new ChromeDriver(options);
		 int j=0;
	Object[][] Bookingdata=FileFunctions.ReadExcelData("D:\\SelenenumTestData\\MappingInputFile_Wyndham.xlsx","List");  
	   for(int i=1;i<Bookingdata.length;i++)
	   {
		   ...
		   String ExpediaHotelname=driver.findElement(By.cssSelector("div.hotel-content>div>h1>span")).getText();
	       ...
	       String ExpediaHotelAddress=driver.findElement(By.cssSelector("div.hotel-content>div>h1+div>span")).getText();
		   ...
		   List<WebElement> allhotels=driver.findElements(By.cssSelector("div.pll-image-container>canvas"));
		   String hotelid=allhotels.get(0).getAttribute("data-info");
		   BookingMap.put(ws_hotelid, hotelid);
		  ...
		  // String ExpediaHotelcountry=driver.findElement(By.cssSelector("div[itemprop=\"address\"]>meta[itemprop=\"addressCountry\"]")).getAttribute("content");
		   ...
		   writeExcel("D:\\SelenenumTestData\\MappingInputFile_Wyndham.xlsx","List",i);
