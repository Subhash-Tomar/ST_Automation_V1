...
public class OTA_Agoda_Manual_Automation 
{
...
final static int countryname=3;
	...
	public void BookingAutomation() throws Exception
	{
     ...
     System.setProperty("webdriver.chrome.driver","D:\\Drivers\\113\\chromedriver.exe");
		...
		String hoteladdress_=Bookingdata[i][address].toString();	
		String Sourcehotelname_main_C=Sourcehotelname_main2+","+city+","+country;
		String Sourcehotelname_main=Sourcehotelname_main2+" ,"+hoteladdress_;

		
		driver.findElement(By.cssSelector("input#textInput")).sendKeys(Keys.CONTROL+"a");
		driver.findElement(By.cssSelector("input#textInput")).sendKeys(Keys.DELETE);
		
		driver.findElement(By.cssSelector("input#textInput")).sendKeys(Sourcehotelname_main_C);
		Thread.sleep(4000);
